...
const SectionOneUZ = () => {
    return (
        <>
            <section id='suvUZ' className='w-full h-full bg-[#f8fcff] font-dosis font-semibold mt-[-100px] md:mt-[-50px]'>
                <div>
                    <div>
                        <div data-aos="fade-up"
                            data-aos-duration="1000" className='flex justify-center'>
                            <div className='w-[150px] h-full'>
                                <h3 className="wavy text-[15px] md:text-xl flex justify-center text-center" href="#">Ko'p suv ichishning ijobiy tomonlari</h3>
                            </div>
                        </div>
                        <br />
