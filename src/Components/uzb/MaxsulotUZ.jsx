...
export default class MaxsulotUZ extends Component {
    render() {
        var settings = {
            dots: true,
            infinite: false,
        ...
        return (
            <>
                <div id="maxsulotUZ" className="flex justify-center font-dosis font-semibold bg-[#f8fcff]">
                    <div className="w-[80%]">
                        <div className='flex justify-center my-8'>
                            <div className='w-[150px] h-full'>
                                <h1 className="wavy text-2xl flex justify-center" href="#">Maxsulotlarimiz</h1>
                            </div>
                        </div>
                        <Slider {...settings}>
                            {
