...
const TolovUZ = () => {
    return (
        <div>
            <section id='tolovUZ' className='font-dosis font-semibold bg-[#f8fcff] pt-8'>
                ...
                <div className='grid grid-cols-3 max-sm:grid-cols-1 max-md:grid-cols-1 max-lg:grid-cols-2 max-xl:grid-cols-3 max-2xl:grid-col-4'>
                    ...
                    <div className='mx-auto my-5 w-[300px] h-[400px] max-sm:w-[250px] max-sm:h-[350px] p-6 border-[1px] border-[#379EFF] card bg-white'>
                        ...
                        <div className='flex justify-center'>
                            <h1 className="text-2xl flex justify-center" href="#"><span className='text-[#379EFF] mr-1'>Karta</span> orqali to'lov </h1>
                        </div>
                        <div className='flex justify-center'>
                    ...
                    <div className='mx-auto my-5 w-[300px] h-[400px] max-sm:w-[250px] max-sm:h-[350px] p-6 border-[1px] border-[#379EFF] card bg-white'>
                        ...
                        <div className='flex justify-center'>
                            <h1 className="text-2xl flex justify-center" href="#"><span className='text-[#379EFF] mr-1'>Ilovalar</span> orqali to'lov </h1>
                        </div>
                        <div className='flex justify-center'>
                            <div className='w-[150px] h-[150px]'>
                                <div className='flex justify-center'>
