...
const HerroBannerEng = () => {
    return (
        <>
            <section id='hero-banerENG' className='bg-hero bg-center bg-cover bg-no-repeat font-dosis font-semibold text-white'>
