...
const LocationSection = () => {
    return (
        <section id="locationENG" className="py-10 font-dosis font-semibold bg-[#f8fcff]">
            <div className='flex justify-center my-8'>
                <div className='w-[150px] h-full'>
                    <h1 className="wavy text-2xl flex justify-center" href="#">Location</h1>
                </div>
            </div>
            ...
            <p className="text-center mt-6 text-gray-600">
                Splash, Abdurauf Fitrat Street, Qibray, Uzbekistan
            </p>
        </section>
    );
};
