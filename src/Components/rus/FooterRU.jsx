    ...
    <>
        ...
        <footer className='w-full h-full mt-[-10px] bg-[#379EFF] font-dosis font-semibold'>
                    ...
                    <div className='grid md:grid-cols-3 mx-0 grid-cols-1 p-2'>
                        ...
                        <div className='w-[250px] h-[300px]'>
                            ...
                            <div className='flex ml-3'>
                                ...
                                <div className='flex items-center ml-2'>
                                    <h1 className='w-full text-2xl text-white'>Меню:</h1>
                                </div>
                            </div>
                        ...
                        <div className='w-[250px] h-[300px] text-white'>
                            ...
                            <div className='flex ml-3'>
                                <div className='h-[40px] border-l-4 border-blue-900'></div>
                                <div className='flex items-center ml-2'>
                                    <h1 className='w-full text-2xl text-white'>Контакт</h1>
                                </div>
                            </div>
                            <div className='ml-5'>
                                {/* 1 */}
            ...
            <div className='w-full h-full'>
                <div className='flex justify-center items-center'>
                    <a href="https://t.me/sky_line_team">
                        <div className='w-[70px] h-[70px]'>
                            <img className='w-full h-full object-cover object-center' src="https://res.cloudinary.com/dcrolfqsj/image/upload/v1676019652/skyline-removebg-preview_afmskk.png" alt="sky-line" />
                        </div>
                    </a>
                ...
                <div>
                    <h3 className='text-white text-center mt-2'>Copyright © Все права защищены</h3>
                </div>
            </div>
        </footer>
    </>
