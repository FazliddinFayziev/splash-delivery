...
const ContactRU = () => {
    return (
        <section id='contactRU' className='font-dosis font-semibold bg-[#f8fcff]'>
            <div className='flex justify-center py-6'>
                <div data-aos="fade-up"
                    data-aos-duration="1000" className='w-[150px] h-full'>
                    <h1 className="wavy text-2xl flex justify-center" href="#">Контакт</h1>
                </div>
            </div>
            <div className='flex justify-center'>
                <div className='justify-center w-[60%] h-full grid md:grid-cols-2 mx-0 grid-cols-1'>
                    <div data-aos="fade-up"
                        data-aos-duration="1000" className='w-full h-[300px]'>
                        ...
                        <div className='flex justify-center h-full items-center'>
                            <div>
                                ...
                                <div data-aos="fade-up"
                                    ...
                                    <h1><a href="https://t.me/splashwaterbot">t.me/splashuzbot</a></h1>
                                </div>
                                {/* 3 */}
                                <div data-aos="fade-up"
                                    data-aos-duration="1000" className='flex'>
