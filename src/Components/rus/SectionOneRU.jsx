                    ...
                    <div>
                        <div className='flex justify-center'>
                            <div data-aos="fade-up"
                                data-aos-duration="1000" className='w-[300px] h-full'>
                                <h1 className="wavy text-[15px] md:text-xl text-center">А вы знали, что употребление <span className='text-[#379EFF]'>большого количества воды:</span></h1>
                            </div>
                        </div>
                        <br />
                        <div className='flex justify-evenly md:text-[20px] sm:text-[15px] text-[10px] mx-4 text-center'>
